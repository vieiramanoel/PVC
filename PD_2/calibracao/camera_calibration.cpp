...
int main(int argc, char** argv) 
{
	...
	while(successes < n_boards)					
	{
		if((frame++ % frame_step) == 0)									//Skip frames
		{
			...
			cvFindCornerSubPix(gray_image, corners, corner_count, cvSize(11,11),cvSize(-1,-1), cvTermCriteria(CV_TERMCRIT_EPS+CV_TERMCRIT_ITER, 28, 0.1 ));
